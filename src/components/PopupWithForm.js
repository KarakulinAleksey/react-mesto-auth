...
function PopupWithForm({ name, title, children, buttonText, isOpen, onClose, onCloseClickConteiner}) {
  return (
    <div className={`popup popup_type_${name} ${isOpen ? "popup_show" : ""}`}  onClick={      
